  ...
  return (
    <div className="space-y-12">
      ...
      <div>
        ...
        {reminderEnabled && (
          <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-success/10 px-4 py-2 text-sm font-medium">
            <Bell className="h-4 w-4 text-success" />
            <span className="text-success">Daily reminders enabled</span>
          </div>
        )}
      </div>
            ...
            {recentWorkouts && recentWorkouts.length > 0 ? (
              <div className="space-y-4">
                {recentWorkouts.map((workout) => (
                  <div 
                    key={workout.id} 
                    className="flex items-center justify-between rounded-xl border border-border bg-muted/50 p-4 hover:bg-muted transition-colors duration-200"
                  >
              ...
              <div className="flex items-center justify-center py-16 rounded-xl bg-muted">
